    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Teacher/scan-attendance">
                    <ListItemIcon>
                        <AssignmentReturnedSharp color={location.pathname.startsWith("/Teacher/scan-attendance") ? 'primary' : 'inherit'} />
                    </ListItemIcon>
                    <ListItemText primary="Scan Attendance" />
                </ListItemButton>
            </React.Fragment>
            <Divider sx={{ my: 1 }} />
            <React.Fragment>
